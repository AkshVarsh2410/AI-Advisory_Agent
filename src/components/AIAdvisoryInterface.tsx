...
const AIAdvisoryInterface = () => {
  ...
  useEffect(() => {
    if (currentView === 'chat' && messages.length === 0) {
      ...
      const welcomeMessage: Message = {
        ...
        content: "Welcome to AI Advisory! I'm here to provide comprehensive business insights and analysis. To get started, I'll need your Company ID and User ID. You can include them in your message, or I'll help you add them when needed.",
        sender: 'ai',
        timestamp: new Date()
      };
  ...
  const extractIds = (message: string) => {
    const companyIdMatch = message.match(/company[-_\s]id\s*:?\s*([a-zA-Z0-9-_]+)/i) || 
  ...
  const startAnalysisProgress = () => {
    ...
    const interval = setInterval(() => {
      ...
      const phaseIndex = Math.min(Math.floor(progress / (totalTime / phases.length)), phases.length - 1);
  ...
  const handleSendMessage = async () => {
    ...
    await processMessage(messageText, extractedIds.companyId, extractedIds.userId);
  };

  const processMessage = async (messageText: string, companyIdVal: string, userIdVal: string) => {
    // Add user message
    ...
    try {
      ...
      const aiMessage: Message = {
        ...
        content: response || "I've completed the analysis of your request. The insights have been processed and recommendations have been generated based on your company's data and current market conditions.",
        sender: 'ai',
        timestamp: new Date()
      };
          ...
          <div className="container mx-auto text-center max-w-4xl">
            <div className="animate-fade-in">
              ...
              <p className="text-xl text-muted-foreground mb-8 max-w-2xl mx-auto">
                Transform your business strategy with comprehensive AI analysis. Get deep insights, market intelligence, and actionable recommendations tailored to your company.
              </p>
              <Button 
                size="lg" 
        ...
        <section className="py-16 px-4">
          <div className="container mx-auto max-w-6xl">
            <div className="text-center mb-12 animate-slide-up">
              ...
              <p className="text-muted-foreground text-lg">Comprehensive analysis across all aspects of your business</p>
            </div>
              ...
              {[
                {
                  ...
                  description: "Deep dive into market trends, opportunities, and competitive landscape"
                },
                {
                  icon: TrendingUp,
                ...
                },
                {
                  ...
                  description: "Understand your customer base and market positioning"
                },
                {
                  icon: Lightbulb,
                  title: "Innovation Opportunities",
                  description: "Discover new market opportunities and innovation paths"
                }
              ].map((feature, index) => (
                <Card key={index} className="p-6 gradient-card border-0 shadow-soft hover:shadow-elegant transition-smooth animate-scale-in">
        ...
        <section className="py-16 px-4 bg-secondary/30">
          <div className="container mx-auto max-w-4xl">
            <div className="text-center mb-12">
              ...
              <p className="text-muted-foreground text-lg">Simple process, powerful insights</p>
            </div>
              ...
              {[
                {
                  ...
                  description: "Share your Company ID and User ID for personalized analysis",
                  icon: Users
                },
                {
                  step: "2",
                  title: "AI Analysis",
                  description: "Our AI conducts thorough analysis in just 5-8 minutes",
                  icon: Brain
                },
                {
                  step: "3",
                  title: "Get Insights",
                  description: "Receive comprehensive insights delivered while you wait",
                  icon: CheckCircle2
                }
              ].map((step, index) => (
                <div key={index} className="text-center">
                  <div className="relative mb-6">
                    ...
                    <Badge variant="secondary" className="absolute -top-1 -right-1 w-8 h-8 rounded-full p-0 flex items-center justify-center font-bold">
                      {step.step}
                    </Badge>
                  </div>
            ...
            <div className="mt-12 p-6 bg-primary-lightest rounded-xl border border-primary-lighter">
              <div className="flex items-center space-x-3 mb-3">
                ...
                <h3 className="font-semibold text-primary">Deep Analysis Worth the Brief Wait</h3>
              </div>
              <p className="text-primary/80">
                Our comprehensive analysis takes 5-8 minutes to ensure thorough evaluation of your business data, 
                market conditions, and strategic opportunities. The depth of insights justifies the brief processing time.
              </p>
            </div>
          </div>
        </section>
          ...
          <div className="container mx-auto max-w-3xl">
            <Card className="p-8 shadow-elegant border-primary-lighter">
              <div className="text-center mb-6">
                ...
                <h2 className="text-2xl font-bold mb-2">Getting Started Requirements</h2>
                <p className="text-muted-foreground">To provide accurate and personalized insights, we need the following information:</p>
              </div>
              ...
              <div className="space-y-4">
                <div className="flex items-start space-x-4 p-4 bg-secondary rounded-lg">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground text-sm">
                      Your unique company identifier for accessing business data and context.
                      <br />
                      <span className="text-xs italic">Example format: COMP-2024-ABC123 or similar alphanumeric code</span>
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-4 p-4 bg-secondary rounded-lg">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground text-sm">
                      Your user identifier for personalized recommendations and access control.
                      <br />
                      <span className="text-xs italic">Example format: USER-123456 or your assigned user code</span>
                    </p>
                  </div>
                </div>
              </div>
    ...
    <div className="h-screen flex flex-col bg-background">
          ...
          <div className="flex items-center space-x-3">
            ...
            <div className="flex items-center space-x-3">
              ...
              <div>
                ...
                <p className="text-xs text-muted-foreground">Professional Business Intelligence</p>
              </div>
            </div>
          </div>
          {analysisProgress && (
        ...
        <div className="border-b border-border bg-card p-4">
          <div className="space-y-2">
            <div className="flex justify-between text-sm">
              <span className="text-muted-foreground">{analysisProgress.phase}</span>
              <span className="text-muted-foreground">{Math.round(analysisProgress.percentage)}%</span>
            </div>
            <Progress value={analysisProgress.percentage} className="h-2" />
            <p className="text-xs text-muted-foreground text-center">
              Estimated time remaining: {formatTime(analysisProgress.timeRemaining)}
            </p>
          </div>
        </div>
      )}
          ...
          <div key={message.id} className="animate-fade-in">
            <div className={`flex items-start space-x-3 ${message.sender === 'user' ? 'flex-row-reverse space-x-reverse' : ''}`}>
              ...
              <div className={message.sender === 'user' ? 'chat-bubble-user' : 'chat-bubble-ai'}>
                ...
                <div className={`flex items-center justify-between mt-2 text-xs ${message.sender === 'user' ? 'text-primary-foreground/70' : 'text-muted-foreground'}`}>
                  <span>{message.timestamp.toLocaleTimeString()}</span>
                  {message.sender === 'user' && message.status && (
                    <span className={`ml-2 ${message.status === 'error' ? 'text-destructive' : ''}`}>
      ...
      <div className="border-t border-border bg-card/50 backdrop-blur-sm p-4">
        ...
        <p className="text-xs text-muted-foreground mt-2 text-center">
          Include your Company ID and User ID in your message for personalized analysis
        </p>
      </div>
      ...
      <Dialog open={showIdDialog} onOpenChange={setShowIdDialog}>
        <DialogContent className="sm:max-w-md">
          ...
          <div className="space-y-4">
            <p className="text-muted-foreground text-sm">
              To provide accurate analysis, please provide your Company ID and User ID:
            </p>
